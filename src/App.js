      ...
      <div class="teaching-images">
        <div className="bottomflex">
          <button type="button" className="buttons">
            <img src="images/return 1.svg" className="left" alt="left" onClick={alterLeft}></img>
          </button>
          <img src={"images/tcr"+count+".jpg"} alt="tutor" className="tutor"></img>
          <button type="button" className="buttons">
            <img src="images/return 2.svg" className="left" alt="left" onClick={alterRight}></img>
          </button>
        </div>
      </div>
    </div>
